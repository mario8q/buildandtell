"""
Django settings for buildandtell project.
...
SECRET_KEY = 'django-insecure-bh=jr=8(rj4la(yh%0xb)o1x!i@a65$dy4617k+)-fzxz^%g#)'
...
WSGI_APPLICATION = 'buildandtell.wsgi.application'
